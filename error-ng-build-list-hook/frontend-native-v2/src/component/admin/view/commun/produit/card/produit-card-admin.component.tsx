        ...
        <View style={{ flexDirection: 'row', width: '100%' }} >
            ...
            <TouchableOpacity onPress={onDetails} style={{ height: 170, marginHorizontal: 10, borderRadius: 15, marginVertical: 10, elevation: 13, backgroundColor: 'white', width: '95%', flexDirection: 'row', justifyContent: 'space-between' }} >
                ...
                <View style={{ marginLeft: 15, marginVertical: 10 }}>
                    ...
                    <View style={styles.infos}>
                        <Text style={{ fontSize: 18, fontWeight: 'bold' }}>- Barcode: </Text>
                        <Text style={{ fontSize: 16, fontWeight: 'bold' }}>{barcode}</Text>
                    </View>
                    <View style={styles.infos}>
                        <Text style={{ fontSize: 18, fontWeight: 'bold' }}>- Discription: </Text>
                        <Text style={{ fontSize: 16, fontWeight: 'bold' }}>{discription}</Text>
                    </View>
                    <View style={styles.infos}>
                        <Text style={{ fontSize: 18, fontWeight: 'bold' }}>- Prix achat moyen: </Text>
                        <Text style={{ fontSize: 16, fontWeight: 'bold' }}>{prixAchatMoyen}</Text>
                    </View>
                    <View style={styles.infos}>
                    ...
                    <View style={styles.infos}>
                        <Text style={{ fontSize: 18, fontWeight: 'bold' }}>- Seuil alert: </Text>
                        <Text style={{ fontSize: 16, fontWeight: 'bold' }}>{seuilAlert}</Text>
                    </View>
