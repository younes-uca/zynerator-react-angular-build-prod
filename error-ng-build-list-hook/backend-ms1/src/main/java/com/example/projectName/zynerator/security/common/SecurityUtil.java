package com.example.projectName.zynerator.security.common;
...
import com.example.projectName.ProjectNameApplication;
...
public class SecurityUtil {
    ...
    public static User getCurrentUser() {
        UserService userService= ProjectNameApplication.getCtx().getBean(UserService.class);
